...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    programs = {
      tmux.extraConfig = ''
        bind-key "C-j" display-popup -E -w 95% -h 95% jjui
    ...
    xdg.configFile =
      let
        ...
        jjuiThemes = pkgs.fetchFromGitHub {
          owner = "vic";
          repo = "tinted-jjui";
          rev = "9ec47f18af319ef0dff45b94b654de492ee24a61";
          sha256 = "sha256-iPo7zAsd57NR5kXUdtNG06ziQti9XkI/3TisZ9eYmQw";
        };
          ...
          "jjui/config.toml" = {
            source = (pkgs.formats.toml { }).generate "jjui-config.toml" {
              ...
              bindings = [
                ...
                { action = "create-pr"; key = "O"; scope = "revisions"; desc = "create pr"; }
